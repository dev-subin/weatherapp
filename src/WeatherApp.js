...
handleClick()
     ...
     <div>
          ...
          <div className="flex justify-center items-center">
            <div className=" w-10/12 md:w-8/12 flex flex-row justify-center items-center bg-white dark:bg-black outline-none rounded-full h-12 dark:text-white">
              ...
              <input
                ...
                className="outline-none text-2xl  pl-5 w-screen rounded-full h-12 bg-white dark:bg-black"
                value={data}
      ...
      {response && (
        <div className=" mt-12 flex flex-col justify-center items-center md:flex-col md:place-content-between lg:flex-col  bg-blue-800 dark:bg-black w-full md:w-8/12  rounded-xl md:ml-44 lg:ml-56 xl:ml-80 xl:flex-row">
          <div >
            <div>
      ...
      <a href="https://github.com/dev-subin">
        ...
        <p className="text-xl text-gray-700 text-center mt-12">
          Developed by <span className="underline">Subin Sabu</span>
        </p>
      </a>
    </div>
    </div>
